...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.4-kirby-problem-2.4-cac9c3b5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.4"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.4-kirby-problem-2.4-cac9c3b5-v1",
      "problem_contract_sha256": "03d286e2676f17812804727a515cd8e6dbbb866f80248b4fdb80cc1207416b80",
      "problem_id": "problem:um-kp-2.4-kirby-problem-2.4-cac9c3b5",
      "route_id": "route:um-kp-2.4-kirby-problem-2.4-cac9c3b5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.4-kirby-problem-2.4-cac9c3b5-source-fidelity-01",
      "graph_id": "graph:um-kp-2.4-kirby-problem-2.4-cac9c3b5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.4-kirby-problem-2.4-cac9c3b5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.4-kirby-problem-2.4-cac9c3b5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $S_{1}$ and $S_{2}$ be orientable surfaces of finite type. Under what conditions do injective maps from (finite-index subgroups of) the mapping class group of $S_{1}$ to the mapping class group of $S_{2}$ necessarily arise from “manipulations” (e.g., inclusions, (branched) coverings, etc.) taking $S_{1}$ to $S_{2}$?"
          },
          "statement_sha256": "fee4c1d5328679297b165f752eeca956a935ebfd5a1ae0112870b88bfeb51a70"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.4-kirby-problem-2.4-cac9c3b5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.4-kirby-problem-2.4-cac9c3b5-root",
      "route_id": "route:um-kp-2.4-kirby-problem-2.4-cac9c3b5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.4-fa3199653890",
        "url": "https://www.unsolvedmath.com/problems/KP-2.4"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
